    ...
    return (
      <>
        <div className="text-container">
          <div class="flex w-1/5 min-w-max max-w-max select-none flex-col justify-center rounded-lg bg-slate-50 bg-opacity-10 p-8 align-middle shadow drop-shadow-2xl backdrop-blur-md">
            <img
              ...
              alt="album cover"
            />
            <div className="now-playing__side overflow-hidden">
              {/* <div className="now-playing__name">{current_track.id}</div> */}
              <div className="mb-2 mt-5 select-none overflow-hidden truncate text-ellipsis text-2xl font-bold tracking-tight text-slate-50">
                {current_track.name}
              </div>
              <div className="mb-2 select-none overflow-hidden truncate text-ellipsis text-xl font-bold tracking-tight text-slate-50">
